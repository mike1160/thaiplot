...
const STATIC_ROUTES: Array<{
  ...
  { path: '/info/buying-land-thailand', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/info/chanote-title-deed', priority: 0.8, changeFrequency: 'monthly' },
  ...
  { path: '/info/visa-retirement-thailand', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/info/paperwork-thailand', priority: 0.8, changeFrequency: 'monthly' },
