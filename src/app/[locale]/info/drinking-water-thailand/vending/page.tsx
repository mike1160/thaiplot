...
export async function generateMetadata({ params }: Props) {
  return buildPageMetadata({
    ...
    path: '/info/drinking-water-thailand/vending',
  })
}

export default function DrinkingWaterVendingPage({ params }: Props) {
  setRequestLocale(params.locale)
  const content = getDrinkWaterContent(params.locale)
  return <DrinkWaterSectionView section={content.vending} />
}
